...
text_entry = [
    [sg.Text("Comparison Tool"), sg.Radio("BLEU Score", "comparison", default=True, key="-BLEU-"), sg.Radio("Sentence Bert", "comparison", key="-BERT-"), sg.Slider(range=(1,100), default_value=50, size=(20,15), orientation="horizontal", key="-SIMILARITY SLIDER-")],
